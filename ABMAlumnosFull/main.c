...
void mostrarAlmuerzoFecha(eAlmuerzo [], eComida comidas[], int tamAl);
...
int menuInformes()
{
    ...
    printf ("12-Carrera amante de la milanesa");
    printf ("13-");
    printf("20-Salir\n\n");
    printf("Ingrese opcion: ");
    scanf("%d", &opcion);
...
void InformesAlumnos(eAlumno alumnos[], int tam, eCarrera carreras[], int tamC, eAlmuerzo almuerzos[], int tamAl, eComida comidas[], int tamCom)
{
    ...
    do
    {
        ...
        case 9:
            mostrarAlmuerzoFecha(almuerzos, tamAl, comidas);
            break;
...
void mostrarAlmuerzoFecha(eAlmuerzo vec[], eComida comidas[], int tamAl){

    eFecha fechaCom;


    printf ("Ingrese fecha: ");
    scanf("%d/%d/%d", &fechaCom.dia, &fechaCom.mes, &fechaCom.anio);

    for (int i = 0 ; i < tamAl ; i ++){

        if (vec[i].fecha.dia == fechaCom.dia && vec[i].fecha.mes == fechaCom.mes && vec[i].fecha.anio == fechaCom.anio){

        mostrarAlmuerzo(vec[i], comidas, tamAl);
